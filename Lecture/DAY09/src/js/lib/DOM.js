...
var DOM = (function (exports) {
	...
	function is(data, type) {
		...
		switch( data.constructor ) {
			case Number:
				result = (type === 'number' || type === 'num');
			break;
			case String:
				result = (type === 'string' || type === 'str');
			break;
			case Boolean:
				result = (type === 'boolean' || type === 'boo');
			break;
			case Function:
				result = (type === 'function' || type === 'fnc');
			break;
			case Array:
				result = (type === 'array' || type === 'arr');
			break;
			case Object:
				result = (type === 'object' || type === 'obj');
		}
